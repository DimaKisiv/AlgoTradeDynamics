...
export default function ResultsView({ run }) {
  ...
  return (
    <motion.div initial="hidden" animate="visible" className="results">
      <motion.header variants={fadeUp} custom={0} className="results__head">
        <div>
        ...
        <Link to={`/runs/${run.id}`} className="results__link">
          Деталі запуску →
        </Link>
      </motion.header>

      <motion.div variants={fadeUp} custom={1} className="results__metrics">
        <MetricCard
          label="Total PnL"
      ...
      <motion.section variants={fadeUp} custom={2} className="results__chart glass-strong">
        <header className="results__section-head">
          <div>
            <span className="eyebrow">Equity Curve</span>
            <h3 className="results__section-title">Динаміка капіталу</h3>
          </div>
          <span className="pill">
            <Activity size={12} />
      ...
      <motion.section variants={fadeUp} custom={3} className="results__journal glass-strong">
        <header className="results__section-head">
          <div>
            <span className="eyebrow">Trade Journal</span>
            <h3 className="results__section-title">Журнал угод</h3>
          </div>
          <span className="pill">
            <Activity size={12} />
